...
const App: React.FC = () => {
  ...
  const Header = () => (
    <div className="bg-[#8b847e] p-6 text-white shadow-lg">
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-4">
          <div className="grid grid-cols-2 gap-2">
            <div className="w-2.5 h-2.5 rounded-full border-2 border-[#1e5d8c]" />
            <div className="w-2.5 h-2.5 rounded-full border-2 border-[#1e5d8c]" />
            <div className="w-2.5 h-2.5 rounded-full border-2 border-[#1e5d8c]" />
            <div className="w-2.5 h-2.5 rounded-full border-2 border-[#1e5d8c]" />
          </div>
          <div className="flex flex-col">
            <h1 className="text-2xl font-black tracking-tight text-[#1e5d8c] leading-none uppercase">AMENA</h1>
            <p className="text-[8px] font-black text-[#1e5d8c] tracking-[0.3em] opacity-80 uppercase leading-none mt-1">COMALAPA DIGITAL</p>
          </div>
        </div>
        <div className="bg-white px-6 py-2 rounded-full shadow-md">
          <span className="text-[12px] font-black text-[#d0833b] uppercase tracking-widest whitespace-nowrap">PASO {step} DE {totalSteps}</span>
        </div>
      </div>
      <div className="h-2 w-full bg-white/20 rounded-full overflow-hidden">
        <motion.div 
          className="h-full bg-[#d0833b] rounded-full shadow-[0_0_10px_rgba(208,131,59,0.5)]" 
          initial={{ width: 0 }}
