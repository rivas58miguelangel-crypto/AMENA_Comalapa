    ...
    <div className="space-y-5">
      ...
      <Card className="border-blue-100 bg-blue-50">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div className="flex flex-wrap gap-3">
            {!activeDemoSession && demoSessionStatus === "blocked" && <button type="button" disabled={demoSessionStatus === "preparing"} onClick={onStartDemoSession} className="rounded-2xl bg-slate-950 px-5 py-3 text-sm font-black text-white disabled:cursor-wait disabled:bg-slate-400">Reintentar preparación</button>}
