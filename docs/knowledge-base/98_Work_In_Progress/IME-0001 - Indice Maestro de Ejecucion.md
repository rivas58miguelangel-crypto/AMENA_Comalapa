...
| IME-014 | docs/knowledge-base/07_Especificaciones_Desarrollo/DEMO-0002 - Especificacion de Comunicaciones Reales WhatsApp Correo Centro Demo.md; docs/knowledge-base/07_Especificaciones_Desarrollo/DEMO-0003 - Topologia Oficial de Despliegue del Centro Demo en VPS Hostinger.md; docs/knowledge-base/07_Especificaciones_Desarrollo/DEMO-0004 - Especificacion Funcional del Cierre Inteligente y Expediente Vivo del Centro Demo.md; TRANSICION-Codex-AMENA-83-A-84-20260720-1851.md; CERT-DESPLIEGUE-RUTA2-0001-app-publica-reservas-https-dokploy.md | Centro Demo / Comunicaciones externas reales | Compromiso tecnico | Especificacion | Pendiente | Alta | Alta | Centro Demo | Implementar, probar y certificar los dos casos reales definidos en DEMO-0002 antes de cerrar el frente | App Publica Ruta 2 ya cuenta con despliegue HTTPS certificado en Dokploy. Permanecen abiertos Caso 1, Caso 2, WhatsApp, correo, Backend Demo API, integraciones y persistencia integral. Reconstruccion obligatoria en chats siguientes y permanencia en transiciones mientras siga abierto. DEMO-0003 fija la topologia minima de despliegue VPS que soporta DEMO-0002. DEMO-0004 fija la manifestacion funcional demo del cierre inteligente, disparo automatico del WhatsApp final del Caso 2, confirmacion humana y Expediente Vivo visible. Prohibido cerrar por publicacion documental, interfaz, endpoint, solicitud aceptada o evidencia simulada. Caso 2 no es WhatsApp inmediato post-reserva: ocurre en el tramo final del recorrido y debe auditar solicitud, envio real o simulado, confirmacion de recepcion por el usuario y cierre definitivo. Requiere actualizar IME-014 y publicar cierre certificado. |
