...
| IME-014 | docs/knowledge-base/07_Especificaciones_Desarrollo/DEMO-0002 - Especificacion de Comunicaciones Reales WhatsApp Correo Centro Demo.md; TRANSICION-Codex-AMENA-83-A-84-20260720-1851.md | Centro Demo / Comunicaciones externas reales | Compromiso tecnico | Especificacion | Pendiente | Alta | Alta | Centro Demo | Implementar, probar y certificar los dos casos reales definidos en DEMO-0002 antes de cerrar el frente | Reconstruccion obligatoria en chats siguientes y permanencia en transiciones mientras siga abierto. Prohibido cerrar por publicacion documental, interfaz, endpoint, solicitud aceptada o evidencia simulada. Requiere actualizar IME-014 y publicar cierre certificado. |
