...
| IME-012 | PD-0003; BLOQUE-03-project-inventory.sql; BLOQUE-04-project-catalog.sql.md | Produccion / Catalogo Comercial | Sistema documental | Conocimiento consolidado | Completado confirmado | Alta | Alta | Ambos | Usar como fuente oficial antes de disenar cualquier bloque posterior del Plan Maestro SQL relacionado con catalogo comercial, inventario, disponibilidad o reservas | PD-0003 fija la arquitectura jerarquica oficial del Catalogo Comercial Parametrizable. Bloque 3 ejecuto project_inventory como inventario comercial base. Bloque 4 ejecuto project_catalog como dominio rector minimo del Catalogo Comercial Parametrizable. |
